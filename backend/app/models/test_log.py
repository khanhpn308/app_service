...
class TestLog(Base):
    ...
    delay_node_to_gateway_ms: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    delay_gateway_to_server_ms: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    delay_node_to_server_ms: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
