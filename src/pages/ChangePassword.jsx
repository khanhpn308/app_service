...
export default function ChangePassword() {
  ...
  if (success) {
    return (
      <div className="max-w-md mx-auto space-y-4 text-center py-12">
        ...
        <h1 className="text-2xl font-bold text-foreground">Đổi mật khẩu thành công</h1>
        <p className="text-muted-foreground">Đang chuyển về Home...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <p className="text-muted-foreground mb-8">Nhập mật khẩu hiện tại và mật khẩu mới</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-card rounded-xl p-8 border border-border">
        {[
          ...
          <div key={key}>
            <label className="block text-sm text-foreground/90 mb-2">{label}</label>
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 bg-background border rounded-lg text-foreground ${
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-3 bg-primary hover:bg-primary/90 text-foreground font-semibold rounded-lg disabled:opacity-50"
        >
